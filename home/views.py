...
class PlanPage(View):
    ...
    def get(self, request):
        plans = [
            {'name': 'Básico', 'velocidad': '10 Mbps', 'soporte': '24/7', 'subida': '5 Mbps','Fibra_óptica': True, 'latencia_baja': False},
            {'name': 'Esencial', 'velocidad': '50 Mbps', 'soporte': '24/7', 'subida': '25 Mbps', 'Fibra_óptica': True, 'latencia_baja': False},
            {'name': 'Intermedio', 'velocidad': '80 Mbps', 'soporte': '24/7', 'subida': '40 Mbps', 'Fibra_óptica': True,
             'latencia_baja': True},
            {'name': 'Avanzado', 'velocidad': '100 Mbps', 'soporte': '24/7', 'subida': '50 Mbps', 'Fibra_óptica': True, 'latencia_baja': True},
            {'name': 'Premium', 'velocidad': '150 Mbps', 'soporte': '24/7', 'subida': '75 Mbps', 'Fibra_óptica': True, 'latencia_baja': True},
            {'name': 'Ultra', 'velocidad': '200 Mbps', 'soporte': 'VIP 24/7', 'subida': '100 Mbps', 'Fibra_óptica': True,
             'latencia_baja': True},
        ]
